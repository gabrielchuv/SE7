...
Finally, as conveyed by our industry review (link), other alternatives have been unsuccessfully trying to balance solutions that offer both convenience and accuracy. Thus, we will focus on resolving inconvenience and inaccuracy to further our main goal of increasing the motivation to waste less.

The specific problem that we will tackle during this project is: the reduction of UK students’ food waste by increasing their motivation to waste less
